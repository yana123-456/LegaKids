        ...
        accessibility: [
            {
                ...
                correctAnswer: "Rightsville"
            }, {
                question: "Why were the kids disappointed?",
                code: ``,
                answers: [
                    "A) The park was too far from their homes.",
                    "B) The park was closed for repairs.",
                    "C) They didn't like playing in parks.",
                    " D) They wanted to play indoors."
                ],
                correctAnswer: "C) The park was closed for repairs."
            }, {
                question: "Who remembered that kids have rights too?",
                code: ``,
                answers: [
                    "A) Lucy",
                    "B) Tom",
                ...
                correctAnswer: "A) Lucy"
            }, {
                question: "What did Lucy and her friends do after seeing the sign?",
                code: ``,
                answers: [
                    "A) They started playing somewhere else.",
                    "B) They wrote a letter to the mayor.",
                    "C) They gave up and went home.",
                    "D) They ignored the sign and entered the park."
                ],
                correctAnswer: "B) They wrote a letter to the mayor."
            }, {
                question: "What did they ask the mayor in their letter?",
                code: ``,
                answers: [
                    "A) They asked for money.",
                    "B) They asked for new toys.",
                    "C) They asked for a temporary play area.",
                    "D) They asked for a bigger park."
                ],
                correctAnswer: "C) They asked for a temporary play area."
            }
        ],
        arrays: [
            {
                question: "How did the mayor respond to their letter?",
                code: ``,
                answers: [
                    "A) He ignored it.",
                    "B) He thanked them and agreed to set up a temporary play area.",
                    "C) He scolded them for writing a letter.",
                    "D) He told them to wait for the park to reopen."
                ],
                correctAnswer: "B) He thanked them and agreed to set up a temporary play area."
            }, {
                question: "How did the kids feel after the mayor's response?",
                code: ``,
                answers: [
                    "A) Disappointed",
                    "B) Overjoyed",
                ...
                correctAnswer: "B) Overjoyed"
            }, {
                question: "What did the kids learn from this story?",
                code: ``,
                answers: [
                    "A) Kids don't have any rights.",
                    "B) Kids have the right to a safe place to play.",
                    "C) The mayor doesn't care about kids.",
                    "D) It's better to stay quiet and not write letters."
                ],
                correctAnswer: "B) Kids have the right to a safe place to play."
            }, {
                question: "Where did the story take place?",
                code: ``,
                answers: [
                ...
                correctAnswer: "B) The park was closed for repairs."
            }
        ],
        //yeha tk question added haii
